...
const data = [
  ...
  /* Iteracion 3 */
  { id: "128", predecessors: ["21", "27"], duration: 3 },
  { id: "129", predecessors: ["21", "27"], duration: 3 },
  ...
  /* Iteracion 4 */
  { id: "28", predecessors: ["129", "135"], duration: 2 },
  { id: "29", predecessors: ["129", "135"], duration: 2 },
  ...
  /* Iteracion 5 */
  { id: "36", predecessors: ["29", "35"], duration: 3 },
  { id: "37", predecessors: ["29", "35"], duration: 3 },
  ...
  /* Iteracion 6 */
  { id: "44", predecessors: ["37", "43"], duration: 3 },
  { id: "45", predecessors: ["37", "43"], duration: 3 },
  ...
  /* Iteracion 7 */
  { id: "52", predecessors: ["45", "51"], duration: 3 },
  { id: "53", predecessors: ["45", "51"], duration: 3 },
  ...
  /* Iteracion 8 */
  { id: "60", predecessors: ["53", "59"], duration: 3 },
  { id: "61", predecessors: ["53", "59"], duration: 3 },
  ...
  /* Iteracion 9 */
  { id: "66", predecessors: ["61", "65"], duration: 3 },
  { id: "67", predecessors: ["61", "65"], duration: 3 },
  ...
  /* Iteracion 10 */
  { id: "73", predecessors: ["67", "72"], duration: 4 },
];
